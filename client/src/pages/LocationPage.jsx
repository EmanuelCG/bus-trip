...
export default function LocationPage() {
    ...
    return (
        <div className="max-w-[1400px] p-4 mx-auto">
            ...
            <button data-modal-target="create-bus-modal" data-modal-toggle="create-bus-modal" href="" type="button" className="inline-flex focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 transition-colors" onClick={() => setCreateModalLocationOpen(true)}>Add location <PlusIcon className="ml-4 size-4" /></button>
            <ModalLocationForm
